            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                >
                  ...
                  {peoples &&
                    peoples.map((p) => (
                      <option key={p.id || p._id} value={p.id || p._id} style={{ color: 'var(--text-primary)' }}>
                        {p.peopleName}
                      </option>
                    ))}
                </select>
              ...
              <div className="col-md-6 mb-3">
                ...
                >
                  <option value="" style={{ color: 'var(--text-muted)' }}>Select Project (Optional)</option>
                  {projects.map((p) => (
                    <option key={p.id || p._id} value={p.id || p._id} style={{ color: 'var(--text-primary)' }}>
                      {p.projectName}
                    </option>
              ...
              <div className="col-md-6 mb-3">
                ...
                >
                  ...
                  {incomeCategories.map((c) => (
                    <option key={c.id || c._id} value={c.id || c._id} style={{ color: 'var(--text-primary)' }}>
                      {c.categoryName}
                    </option>
                  ))}
                </select>
              ...
              <div className="col-md-6 mb-3">
                ...
                >
                  ...
                  {filteredSubCategories.map((sub) => (
                    <option key={sub.id || sub._id} value={sub.id || sub._id} style={{ color: 'var(--text-primary)' }}>
                      {sub.subCategoryName}
                    </option>
                  ))}
                </select>
